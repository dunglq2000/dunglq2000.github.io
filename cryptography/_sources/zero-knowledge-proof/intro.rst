...
.. admonition:: Tính chất của zero knowledge proof
   ...
   3. Zero-knowledge: verifier không học được thông tin nào ngoài
      việc mệnh đề có hợp lệ hay không.
...
Một tham số bí mật :math:`\lambda` giúp sinh ra proving key :math:`pk`
và verification key :math:`vk`.
