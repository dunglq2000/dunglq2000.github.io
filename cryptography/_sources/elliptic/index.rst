...
Nếu đặc số khác $2$ hoặc $3$, ta có thể biến đổi dạng tổng quát về dạng cơ bản với

.. math:: 
   
   \begin{array}{cccc}
      & y^2 + 2 \cdot y \cdot \dfrac{a_1 x}{2} + \dfrac{a_1^2 x^2}{4} + a_3 \left(y + \dfrac{a_1 x}{2}\right) & = & x^3 + a_2 x^2 + \left(a_4 + \dfrac{a_3 a_1}{2}\right) x + a_0 + \dfrac{a_1^2 x^2}{4} \\ \Longleftrightarrow & \left(y + \dfrac{a_1 x}{2} + \dfrac{a_3}{2}\right)^2 & = & x^3 + \left(a_2 + \dfrac{a_1^2}{4}\right) x^2 + \left(a_4 + \dfrac{a_1 a_3}{2}\right) x + \left(\dfrac{a_3^2}{4} + a_0\right) \\ \Longleftrightarrow & y_1^2 & = & x^3 + a_2' x^2 + a_4' x + a_6'.
   \end{array}

Đặt $x_1 = x + \dfrac{a_2'}{3}$ thì ta có phương trình mới dạng

.. math:: y_1^2 = x_1^3 + A x_1 + B.
