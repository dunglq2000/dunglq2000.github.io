...
Bài này ta làm sau khi giải kết thúc.
...
Để giải bài này ta cần định lý Wilson:
...
Do :math:`k = n^2 + 4n + 3 = (n + 1) \cdot (n + 3)`, ta mong muốn tìm số :math:`n` thỏa mãn hai phương trình
...
Như vậy nếu điều kiện cuối là :math:`4 \cdot \dfrac{-1}{(n+2) \cdot (n+1)} + 2 \equiv 0 \pmod{n+3}` thỏa mãn thì ta đã tìm được số :math:`n` cần thiết.
