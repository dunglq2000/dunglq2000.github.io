...
Hạng của ma trận :math:`\bm{A}` được kí hiệu là :math:`\rank(\bm{A})`.
...
Ví dụ, xét ma trận :math:`\bm{A} = \begin{pmatrix} 1 & 2 & 3 \\ 2 & 4 & 6 \\ 1 & 2 & 4 \end{pmatrix}`. Ma trận :math:`\bm{A}` có định thức :math:`\det(\bm{A}) = 0`, nhưng ma trận con của :math:`\bm{A}` là :math:`\bm{B} = \begin{pmatrix} 2 & 3 \\ 2 & 4 \end{pmatrix}` (lấy dòng 1 và 3, lấy cột 2 và 3) có định thức :math:`\det(\bm{B}) = 2 \neq 0`, do đó :math:`r = \rank (\bm{A}) = 2`.
