...
Cho tam giác có các đỉnh :math:`\bm{p}_0, \bm{p}_1, \bm{p}_2`. Mọi điểm trong mặt phẳng tam giác có thể viết

.. math::

   \bm{p} = \lambda_0 \bm{p}_0 + \lambda_1 \bm{p}_1 + \lambda_2 \bm{p}_2,
   \qquad
   \lambda_0 + \lambda_1 + \lambda_2 = 1.

Điểm nằm trong tam giác kín khi :math:`\lambda_i \geqslant 0` với mọi :math:`i`. Các hệ số :math:`\lambda_i` là tọa độ barycentric và cũng chính là trọng số nội suy thuộc tính theo đỉnh.
...
.. math::
   ...
   E_{p_0 p_1}(\bm{p}),
   \quad E_{p_1 p_2}(\bm{p}),
   \quad E_{p_2 p_0}(\bm{p})
...
.. math:: a = \lambda_0 a_0 + \lambda_1 a_1 + \lambda_2 a_2.
...
.. math::
   ...
   a(\bm{p})
   = \frac{\displaystyle \sum_{i = 0}^2 \lambda_i \dfrac{a_i}{w_i}}
          {\displaystyle \sum_{i = 0}^2 \lambda_i \dfrac{1}{w_i}}.
