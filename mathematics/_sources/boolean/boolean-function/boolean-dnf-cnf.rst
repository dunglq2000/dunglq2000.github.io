...
2. Nếu :math:`f = 1`, với :math:`i \in [n]` ta xây dựng term như sau:
...
2. Nếu :math:`f = 0`, với :math:`i \in [n]` ta xây dựng term như sau:
...
.. figure:: ../../figures/karnaugh/karnaugh-01.*
...
.. figure:: ../../figures/karnaugh/karnaugh-02.*
...
.. figure:: ../../figures/karnaugh/karnaugh-dnf-01.*
...
Luôn nhớ rằng trong DNF thì giá trị :math:`1` ta giữ nguyên (ví dụ :math:`x_3`) còn giá trị :math:`0` thì ta đảo (ví dụ :math:`\neg x_1`).
...
.. figure:: ../../figures/karnaugh/karnaugh-dnf-02.*
