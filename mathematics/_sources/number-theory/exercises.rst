...
Chứng minh rằng, nếu :math:`m`, :math:`n` là các số nguyên lớn hơn :math:`1` thì :math:`n^4 + 4^n \cdot m^4` là hợp số.

----

Chứng minh rằng nếu :math:`m \mid n` thì :math:`\varphi(m) \mid \varphi(n)`.
