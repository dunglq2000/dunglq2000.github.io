...
.. math:: \lvert MF_1 - MF_2 \rvert = \left\lvert \sqrt{(x+c)^2 + y^2} - \sqrt{(x-c)^2 + y^2} \right\rvert = 2a,

tương ứng với biển đổi thành phương trình

.. math:: \frac{x^2}{a^2} - \frac{y^2}{c^2 - a^2} = 1.

Đặt :math:`b^2 = c^2 - a^2` thì phương trình của hyperbol trở thành

.. math:: \frac{x^2}{a^2} - \frac{y^2}{b^2} = 1.

.. figure:: ../../figures/conics/hyperbola.*

   Hyperbol với phương trình :math:`\dfrac{x^2}{16} - \dfrac{y^2}{9} = 1`
