...
Thales của Miletus được cho rằng sinh vào khoảng năm 624 Trước Công nguyên (TCN) và mất năm 547 TCN tại Miletus (Thổ Nhĩ Kì ngày nay) [#thales]_.
...
.. figure:: ../../figures/analytic_geometry/thales_theorem-01.*

	Định lý Thales trên mặt phẳng

Theo định lý Thales, nếu :math:`EF` song song với :math:`BC` thì ta có :math:`\dfrac{AE}{AB} = \dfrac{AF}{AC} = \dfrac{EF}{BC}` ({numref}`thales1`).
...
.. figure:: ../../figures/analytic_geometry/thales_theorem-02.*

	Định lý Thales trong không gian

Theo định lý Thales, nếu mặt phẳng :math:`(ABCD)` song song với mặt phẳng :math:`(A'B'C'D')` thì :math:`\dfrac{SA}{SA'} = \dfrac{SB}{SB'} = \dfrac{SC}{SC'} = \dfrac{SD}{SD'}` ({numref}`thales2`).
...
Pythagoras của Samos cũng là nhà triết học Hy Lạp cổ, được cho rằng sinh vào khoảng năm 570 TCN và mất năm  490 TCN [#pythagoras]_.
...
Một trong những khám phá đó là về sự tồn tại của số vô tỉ dựa vào định lý mang tên ông. Lịch sử đã chỉ ra rằng trước Pythagoras, người Babylon và Ai Cập đã tìm ra rất nhiều bộ số nguyên :math:`(a, b, c)` thỏa mãn :math:`a^2 + b^2 = c^2` là độ dài ba cạnh tam giác vuông. Định lý Pythagoras mà ngày nay chúng ta biết được phát biểu rằng:
...
Như vậy nếu gọi độ dài cạnh huyền là :math:`c`, độ dài hai cạnh góc vuông lần lượt là :math:`a` và :math:`b` thì :math:`a^2 + b^2 = c^2` ({numref}`pythagoras1`).

.. _pythagoras1:

.. figure:: ../../figures/analytic_geometry/pythagoras_theorem.* 

	Định lý Pythagoras

Nếu :math:`a = b = 1` thì sao? Khi đó bình phương độ dài cạnh huyền :math:`c^2 = 2`. Tuy nhiên không thể tìm ra một số hữu tỉ nào để bình phương lên là 2 cả. Phát hiện này là một chấn động đối với thời Pythagoras và ông yêu cầu tất cả thành viên trong hội phải giữ kín bí mật về sự phát hiện này. Tuy nhiên thông tin vẫn lọt ra ngoài và truyền thuyết kể rằng ông đã xử tội chết cho thành viên của hội không tuân thủ.
...
Euclid của Alexandria sinh vào khoảng năm 325 TCN và mất vào khoảng năm 265 TCN [#euclid]_. Thông tin về ông không có nhiều. Nhưng chỉ mỗi bộ sách **Elements** cũng đủ để người đời sau cho rằng ông là người có ảnh hưởng nhất trong 2000 năm lịch sử phát triển của toán học.
