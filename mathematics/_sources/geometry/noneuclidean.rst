...
- qua hai điểm phân biệt chỉ vẽ được một đường thẳng: với hai điểm :math:`A` và :math:`B` bất kì thuộc mặt phẳng phi Eulicd, nếu :math:`AB \perp xx'` thì ta vẽ đường thẳng :math:`AB`, ngược lại ta vẽ đường trung trực của :math:`AB` cắt :math:`xx'` tại :math:`I` và vẽ đường tròn tâm :math:`I`, bán kính :math:`IA`. Như vậy các đường thẳng được xác định duy nhất
...
Từ hình vẽ trên có thể thấy có nhiều hơn một đường thẳng song với :math:`(d_2)` mà đi qua điểm :math:`C` là đường tròn màu cam và đường tròn màu xanh nước suối.
