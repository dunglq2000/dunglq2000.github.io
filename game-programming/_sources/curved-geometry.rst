...
đoạn thẳng xuyên qua không gian bao quanh. Với bề mặt gồm các điểm
:math:`S(u,v)`, hai vector tiếp xúc :math:`S_u,S_v` cho vi phân

.. math:: dS = S_u\,du+S_v\,dv.
...
Nếu :math:`\widehat{\bm{u}}` và :math:`\widehat{\bm{v}}` là hai hướng đơn
...
.. math::
   ...
   = R \arccos \bigl(\operatorname{clamp}
      (\widehat{\bm{u}} \cdot \widehat{\bm{v}}, -1, 1)\bigr).
...
.. math::
   ...
   L[\gamma]
   = \int_a^b
    \sqrt{\gamma'(t)^{\mathsf T}
           g(\gamma(t))\gamma'(t)}\, dt.
