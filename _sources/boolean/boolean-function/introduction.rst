...
Hàm Boolean :math:`f` đối với các biến :math:`x_1`, :math:`x_2`, ..., :math:`x_n` là hàm số nhận giá trị trong :math:`\mathbb{F}_2^n` và trả về giá trị thuộc :math:`\mathbb{F}_2`. Nói cách khác :math:`f` là ánh xạ từ :math:`\mathbb{F}_2^n` tới :math:`\mathbb{F}_2`.
