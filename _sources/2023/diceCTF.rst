...
* lấy tham số là hai public key :math:`pk_0` và :math:`pk_1`, và plaintext :math:`msg` có :math:`16` byte;
* random một chuỗi :math:`r` có :math:`16` byte;
* tính :math:`r\_ prime = r \oplus msg`;
* tính :math:`ct_0 = \text{ENC}(r, pk_0)` và :math:`ct_1 = \text{ENC}(r\_prime, pk_1)`;
* cả hai ciphertext đều dùng padding là OAEP và hash là SHA256 nên độ dài là :math:`256` byte. Hàm trả về ghép hai chuỗi ciphertext lại (:math:`512` byte).
