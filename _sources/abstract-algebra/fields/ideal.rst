...
.. prf:definition:: Principal Ideal
    ...
    Nếu :math:`I = a` với :math:`a` là phần tử nào đó trong :math:`R` thì :math:`I` được gọi là **principal ideal** (hay **ideal chính**, **главный идеал**).
...
.. admonition:: Chứng minh
    ...
    Ta chứng minh chiều thuận, chiều ngược tương tự. Sử dụng phản chứng, ta giả sử :math:`n` là hợp số. Khi đó :math:`n = n_1 n_2` với :math:`n_1 \geqslant n_2 > 1`.
