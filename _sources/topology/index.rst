...
.. prf:example:: 
   ...
   Topo thô hay topo tầm thường (indiscrete/trivial) là tập :math:`\tau = \{ \emptyset, X \}`. Topo này chỉ gồm hai phần tử là tập rỗng và bản thân tập :math:`X`. Dễ thấy ba tiên đề được thỏa mãn.
...
Tập đóng (closed set, замкнутое множество) nếu phần bù của nó trong :math:`X` là tập mở. Nói cách khác, nếu :math:`F \subseteq X` là tập đóng thì :math:`X \setminus F` là tập mở.
